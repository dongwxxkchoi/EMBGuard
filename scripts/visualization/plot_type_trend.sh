...
# ============================================
# Input CSV file (type-based results)
CSV_FILE="results/EMBGuardTest/aggregated_results_by_type.csv"

# Output file
OUTPUT_DIR="results/figures"
OUTPUT_FILE="${OUTPUT_DIR}/type_trend_potential_risk.png"
...
echo "============================================================"
echo "EMBGuard Type Trend Visualization"
echo "============================================================"
